    ...
    <div className="bg-white dark:bg-[#221a10] min-h-screen">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-10 py-8 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <ScrollReveal variant="slideRight" className="flex flex-col h-full">
            <div className="mb-2">
            ...
            <div className="mt-auto">
              <ScrollReveal variant="scale" delay={0.4} className="bg-[#fcfbf9] dark:bg-[#2c241b] rounded-xl border-2 border-primary/20 p-6 md:p-8 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10 flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                    ...
                    <span>Store Open: 08:30 - 17:30 (Mon-Fri)</span>
                  </div>
                </div>
              </ScrollReveal>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-10">
          ...
          <ScrollReveal variant="slideUp" staggerChildren={0.1} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map(p => (
              <ScrollReveal key={p.id} variant="slideUp">
