    ...
    <>
      ...
      <div className="relative w-full bg-[#221a10] py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-40">
          <div className="w-full h-full bg-cover bg-center" style={{backgroundImage: 'url("/contact-section.webp")'}}></div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            <div className="lg:col-span-5 flex flex-col gap-10">
              <ScrollReveal variant="slideLeft" staggerChildren={0.2}>
                <h2 className="text-2xl font-bold text-background-dark dark:text-white mb-8">Get in Touch</h2>
                <div className="space-y-8">
                  <ScrollReveal variant="slideLeft" className="flex items-start gap-5 group">
                  ...
                  <ScrollReveal variant="slideLeft" className="flex items-start gap-5 group">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-background-dark dark:text-white mb-1">Follow Us</h3>
                      <div className="flex gap-4 mt-2">
                        <a 
                          href="https://www.facebook.com/share/18aLzcVUTd/" 
                          target="_blank" 
                          rel="noopener noreferrer" 
                          className="w-10 h-10 rounded-xl bg-gray-100 dark:bg-white/5 flex items-center justify-center text-background-dark dark:text-white hover:bg-primary hover:text-white transition-all duration-300"
                          title="Facebook"
                        >
              ...
              <ScrollReveal variant="scale" delay={0.4} className="bg-white dark:bg-[#2c241b] rounded-2xl p-6 md:p-8 shadow-sm border border-[#e5e0d8] dark:border-[#3a3228]">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100 dark:border-white/5">
                    ...
                    <span className="text-background-dark dark:text-white font-bold">08:30 - 17:30</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100 dark:border-white/5">
                    <span className="text-gray-600 dark:text-gray-400 font-medium">Saturday</span>
                    <span className="text-background-dark dark:text-white font-bold">09:00 - 15:00</span>
                  </div>
